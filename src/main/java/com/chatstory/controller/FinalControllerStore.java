...
public class FinalControllerStore {
    ...
    public FinalControllerStore(String configFilePath) {
    ...
    private void load() {
        ...
        try (Reader reader = Files.newBufferedReader(configFilePath, StandardCharsets.UTF_8)) {
            ...
            System.err.println("[FinalControllerStore] Failed to load: " + e.getMessage());
        }
    }
    ...
    private void save() {
        ...
        try (Writer writer = Files.newBufferedWriter(configFilePath, StandardCharsets.UTF_8,
            ...
            System.err.println("[FinalControllerStore] Failed to save: " + e.getMessage());
        }
    }
