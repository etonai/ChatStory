...
public class SessionControllerStore {
    ...
    public SessionControllerStore(String configFilePath) {
    ...
    private void load() {
        ...
        try (Reader reader = Files.newBufferedReader(configFilePath, StandardCharsets.UTF_8)) {
            ...
            System.err.println("[SessionControllerStore] Failed to load: " + e.getMessage());
        }
    }
    ...
    private void save() {
        ...
        try (Writer writer = Files.newBufferedWriter(configFilePath, StandardCharsets.UTF_8,
            ...
            System.err.println("[SessionControllerStore] Failed to save: " + e.getMessage());
        }
    }
